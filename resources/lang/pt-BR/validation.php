...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sex'                       => 'sexo',
        'travel'                    => 'disponibilidade para viajar',
        'change'                    => 'disponibilidade para mudar-se',
        'journey_id'                => 'jornada de trabalho',
        'contract_type_id'          => 'tipo de contrato',
        'min_hierarchy_id'          => 'hierárquia mínima',
        'max_hierarchy_id'          => 'hierárquia máxima',
        'salary'                    => 'salário',
        'name'                      => 'nome',
        'activity'                  => 'atividades',
        ...
        'finishMonth'               => 'mês de término',
        'finishYear'                => 'ano de término',
        'start_month'                => 'mês de inicio',
        'start_year'                 => 'ano de inicio',
        'finish_month'               => 'mês de término',
        'finish_year'                => 'ano de término',
        'situation'                 => 'situação',
