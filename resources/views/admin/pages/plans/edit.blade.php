                        ...
                        <div class="box-body">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select name="type" class="form-control">
                                        <option value="empresa"
                                            <?php echo $plan->type == 'empresa' ? 'selected' : "" ?>>Empresa</option>
                                        <option value="candidato"
                                            <?php echo $plan->type == 'candidato' ? 'selected' : "" ?>>Candidato
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" disabled name="preApprovalName" value="{{$plan->name}}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="value" value="{{$plan->value}}"
