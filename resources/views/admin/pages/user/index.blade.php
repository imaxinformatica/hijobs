                ...
                <tbody>
                  @forelse($users as $user)
                    <tr>
                      <td>{{$user->name}}</td>
                      <td>{{$user->email}}</td>
                      <td>@if($user->user_type == 1)Admin @else Colaborador @endif</td>
                      <td>
                        <a href="{{ route('admin.user.edit', ['id' => $user->id])}}" title="edittar" class="act-list">
                          <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin.user.destroy', ['id' => $user->id])}}" title="Excluir" class="act-list act-delete">
