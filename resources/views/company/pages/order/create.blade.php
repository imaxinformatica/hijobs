    ...
    <section class="content">
                ...
                <form id="dataOrder" method="POST" action="{{route('admin.order.store')}}" >
                  ...
                  <div class="form-group row">
                    <div class="col-lg-3">
                      ...
                      <input type="text" name="freight" class="form-control input-money" id="freight" value="0,00">
                    </div>
                    <div class="col-lg-3">
                      <label for="discount">Desconto</label>
                      <input type="text" name="discount" class="form-control input-money" id="discount" value="0,00">
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                      ...
                      <input type="text" name="total" class="form-control input-money" id="total" value="{{$order->totalOrder}}" readonly>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-3">
                      <a href="{{route('admin.order.destroy', ['id' => $order->id])}}" class="btn btn-primary">Cancelar Pedido</a>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <div class="row">
        <section class="col-lg-6">
          <div class="box">
            <form id="productOrder" action="{{route('admin.order.product')}}">
              {{csrf_field()}}
              <input type="hidden" name="order_id" value="{{$order->id}}">
              <div class="box-header with-border" >
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary act-order-product">Pesquisar</button>
              </div>
            </form>
          </div>
        </section>
        ...
        <section class="col-lg-6">
          <div class="box">
            <form id="batchOrder" action="{{route('admin.order.batch')}}">
              {{csrf_field()}}
              <input type="hidden" name="order_id" value="{{$order->id}}">
              <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group row box-nome">
                  <div class="col-xs-12">
                    ...
                    <input type="text" name="batch_code" class="form-control" id="batch_code" autofocus>
                  </div>
                </div>
              </div>
              <div class="box-footer">
                ...
                <tbody>
                  @forelse($order->products as $product)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.order.product.destroy', ['order_id' => $order->id, 'product_id' => $product->id])}}" title="Excluir" class="act-list act-delete">
                ...
                <tbody>
                  @forelse($order->batchs()->get() as $batch)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.order.batch.destroy', ['order_id' => $order->id, 'batch_id' => $batch->id])}}" title="Excluir" class="act-list act-delete">
                          <i class="fa fa-minus-square-o" aria-hidden="true"></i>
                      </td>
                    </tr>
                  @empty
