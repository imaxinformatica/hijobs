  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{ route('admin.provider.create')}}'">Novo</button>
        </div>
      </div>
    </section>
                ...
                <tbody>
                  @forelse($providers as $provider)
                    <tr>
                      ...
                      <td>{{$provider->trade}}</td>
                      <td>{{$provider->cnpj}}</td>
                      <td>{{$provider->email}}</td>
                      <td>{{$provider->phone}}</td>
                      <td>
                        <a href="{{ route('admin.provider.edit', ['id' => $provider->id])}}" title="Editar" class="act-list">
                          <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin.provider.destroy', ['id' => $provider->id])}}" title="Excluir" class="act-list act-delete">
